...
class Quest(models.Model):
    ...
    previous_quest = models.OneToOneField('self', on_delete=models.SET_NULL, null=True, related_name='prv_quest')
    next_quest = models.OneToOneField('self', on_delete=models.SET_NULL, null=True, related_name='nxt_quest')
