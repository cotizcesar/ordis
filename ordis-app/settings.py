"""
Django settings for ordis-app project.
...
INSTALLED_APPS = [
    ...
    'bootstrap4',
    # ordis-app: Core (Index, Pages, etc)
    'core',
    # ordis-app: Market app.
    'market',
    # ordis-app: Alerts app.
    'alerts',
    # ordis-app: Codex app.
    'codex',
...
WSGI_APPLICATION = 'ordis-app.wsgi.application'
